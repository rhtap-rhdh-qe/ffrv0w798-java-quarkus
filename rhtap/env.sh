...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/ffrv0w798-java-quarkus-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.kx-e970b82a90.apom.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.kx-e970b82a90.apom.p3.openshiftapps.com}
